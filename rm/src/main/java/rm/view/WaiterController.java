...
import rm.controller.OrderService;
...
import rm.util.TableSelectionUtils;
import rm.view.component.ChangePasswordDialog;
...
import rm.view.component.WaiterNotificationCardFactory;
import rm.view.component.WaiterNotificationCardFactoryClassic;
import rm.view.component.WaiterNotificationCardFactoryEink;
...
public class WaiterController {
    ...
    private void showTableFilterDialog() {
        ...
        dialog.showAndWait().ifPresent(input -> {
            java.util.Set<Integer> selectedTables = TableSelectionUtils.parseTableString(input);
