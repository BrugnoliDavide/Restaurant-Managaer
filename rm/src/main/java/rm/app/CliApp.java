...
import rm.controller.FinancialService;
import rm.controller.FinancialUseCase;
...
public class CliApp {
    ...
    private static void listOrdersToPay() {
        printOrderTable(OrderService.getToPay(), "ORDINI DA PAGARE");
    }

    private static void listKitchenActive() {
        printOrderTable(OrderService.getKitchenActive(),
    ...
    private static void printOrderItems(int orderId) {
        List<OrderItem> items =
                OrderService.getItemsDetailed(orderId);
