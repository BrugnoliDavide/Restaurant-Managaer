...
import rm.preference.DemoModeManager;
import rm.preference.KitchenPreferences;
import rm.preference.PreferencesConstants;
import rm.preference.PreferencesSerializer;
...
import static rm.view.KitchenController.logger;
